...
import static Acciones_Ac.PasarMercaderia_Producto_1.nbodega0;
 ...
 * @author Rau
 */
public class PasarMercaderia_1_A_Otra {
...
por último la cantidad.*/
    ...
    public PasarMercaderia_1_A_Otra() {
            ...
            try {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        nbodega1 = nbodega0 - 1;
                        nbodega2 = opcion - 1;
                        if (producto_1[nbodega1] > cantidad && (producto_1[nbodega2] + cantidad) < x + 1) {
                            producto_1[nbodega2] = producto_1o[nbodega2] + cantidad;
                            producto_1[nbodega1] = producto_1o[nbodega1] - cantidad;
                            System.out.println("- Exito al Pasar Mercaderia");
                            salir = false;
                            break;
                        } else if (producto_1[nbodega1] < cantidad) {
                            System.out.println("- No se Puede Mover Hay Poco Producto");
                            salir = false;
                            break;

                        } else if ((producto_1[nbodega2] + cantidad) > x + 1) {
