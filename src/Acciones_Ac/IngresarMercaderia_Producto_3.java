 ...
 * @author Rau
 */
public class IngresarMercaderia_Producto_3 {
...
que la cantidad a ingresar no exceda el límite de la mercadería.*/
    ...
    public IngresarMercaderia_Producto_3() {
            ...
            try {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        cantidad = sn.nextInt();
                        nbodega = opcion - 1;
                        if ((cantidad + producto_3[nbodega]) < x + 1) {
                            System.out.println("- Exito al Agregar Mercaderia");
                            producto_3[nbodega] += cantidad;
                            salir = false;
                            break;
                        } else {
                            aun = x - producto_3[nbodega];
