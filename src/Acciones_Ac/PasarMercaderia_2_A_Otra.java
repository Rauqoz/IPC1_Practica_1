...
import static Acciones_Ac.PasarMercaderia_Producto_2.nbodega0;
 ...
 * @author Rau
 */
public class PasarMercaderia_2_A_Otra {
...
por último la cantidad.*/
    ...
    public PasarMercaderia_2_A_Otra() {
        do {
            ...
            try {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        nbodega1 = nbodega0 - 1;
                        nbodega2 = opcion - 1;
                        if (producto_2[nbodega1] > cantidad && (producto_2[nbodega2] + cantidad) < z + 1) {
                            producto_2[nbodega2] = producto_2o[nbodega2] + cantidad;
                            producto_2[nbodega1] = producto_2o[nbodega1] - cantidad;
                            System.out.println("- Exito al Pasar Mercaderia");
                            salir = false;
                            break;
                        } else if (producto_2[nbodega1] < cantidad) {
                            System.out.println("- No se Puede Mover Hay Poco Producto");
                            salir = false;
                            break;

                        } else if ((producto_2[nbodega2] + cantidad) > z + 1) {
