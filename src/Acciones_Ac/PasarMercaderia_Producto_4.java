 ...
 * @author Rau
 */
public class PasarMercaderia_Producto_4 {
...
por último la cantidad.*/
    ...
    public PasarMercaderia_Producto_4() {
        ...
        do {
            ...
            try {
                ...
                switch (nbodega0) {
                    case 1:
                        PasarMercaderia_4_A_Otra pasarMercaderia_4_A_Otra1 = new PasarMercaderia_4_A_Otra();
                        salir = false;
                        break;

                    case 2:
                        PasarMercaderia_4_A_Otra pasarMercaderia_4_A_Otra2 = new PasarMercaderia_4_A_Otra();
                        salir = false;
                        break;

                    case 3:
                        PasarMercaderia_4_A_Otra pasarMercaderia_4_A_Otra3 = new PasarMercaderia_4_A_Otra();
                        salir = false;
                        break;

                    case 4:
                        PasarMercaderia_4_A_Otra pasarMercaderia_4_A_Otra4 = new PasarMercaderia_4_A_Otra();
                        salir = false;
                        break;

                    case 5:
                        PasarMercaderia_4_A_Otra pasarMercaderia_4_A_Otra5 = new PasarMercaderia_4_A_Otra();
                        salir = false;
                        break;

                    case 6:
                        PasarMercaderia_4_A_Otra pasarMercaderia_4_A_Otra6 = new PasarMercaderia_4_A_Otra();
                        salir = false;
                        break;

                    case 7:
                        PasarMercaderia_4_A_Otra pasarMercaderia_4_A_Otra7 = new PasarMercaderia_4_A_Otra();
                        salir = false;
                        break;

                    case 8:
                        PasarMercaderia_4_A_Otra pasarMercaderia_4_A_Otra8 = new PasarMercaderia_4_A_Otra();
                        salir = false;
                        break;

                    case 9:
                        PasarMercaderia_4_A_Otra pasarMercaderia_4_A_Otra9 = new PasarMercaderia_4_A_Otra();
                        salir = false;
                        break;
