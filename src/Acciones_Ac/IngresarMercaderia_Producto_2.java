 ...
 * @author Rau
 */
public class IngresarMercaderia_Producto_2 {
...
que la cantidad a ingresar no exceda el límite de la mercadería.*/
    ...
    public IngresarMercaderia_Producto_2() {
            ...
            try {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        cantidad = sn.nextInt();
                        nbodega = opcion - 1;
                        if ((cantidad + producto_2[nbodega]) < z + 1) {
                            System.out.println("- Exito al Agregar Mercaderia");
                            producto_2[nbodega] += cantidad;
                            salir = false;
                            break;
                        } else {
                            aun = z - producto_2[nbodega];
